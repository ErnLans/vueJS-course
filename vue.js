...
const App = {
    data() {
        return {
            ...
            steps: [
                ...
                {title: 'Vuex', text: 'В блоке  вы  узнаете  абсолютно  все  про  Vuex.  Вы  узнаете  как  работать  с  данными,  какие  есть  лучшие  практики  по  их  возможному  программированию  и  структурированию.  Все  на  практичесих  примерах.'},
    ...
    computed: {
        ...
        selectedStep(){ return this.steps[this.activeIndex] },

        // 2. выключена ли кнопка назад
        backButton() { return this.activeIndex === 0 },

        // 3. находимся ли мы на последнем шаге (если да, то true)
        lastStep() { return this.activeIndex === this.steps.length-1}
    }
}
